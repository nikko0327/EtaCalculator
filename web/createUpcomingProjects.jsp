...
<div id="createDrive">
    <form id="myForm" action="createUpcomingProject" class="form-horizontal" method="POST">
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="customer_name"  title="Customer Name" placeholder="Customer Name" required>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="estimated_size"  title="Previous HERE" placeholder="Size" required>
            </div>
        </div>
